...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-tools@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-tools/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-tools@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/random-tools/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-tools@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/random-tools/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/random-tools/actions/workflows/test.yml?query=branch:v0.1.1
...
[@stdlib/random/tools/binary-factory]: https://github.com/stdlib-js/random-tools-binary-factory/tree/umd

[@stdlib/random/tools/binary]: https://github.com/stdlib-js/random-tools-binary/tree/umd

[@stdlib/random/tools/ternary-factory]: https://github.com/stdlib-js/random-tools-ternary-factory/tree/umd

[@stdlib/random/tools/ternary]: https://github.com/stdlib-js/random-tools-ternary/tree/umd

[@stdlib/random/tools/unary-factory]: https://github.com/stdlib-js/random-tools-unary-factory/tree/umd

[@stdlib/random/tools/unary]: https://github.com/stdlib-js/random-tools-unary/tree/umd
